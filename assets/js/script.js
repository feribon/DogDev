...
let testimonials = [
  {
    quote:
      '"Mais do que nunca, os anumais de estimação são tratados como membros da família"',
    origin: "cbs.svg",
  },
  {
    quote:
      '"DogDev é um serviço de entrega direto ao consumidor, preparado na hora com ingredientes 100% reais. Ingredientes que os humanos reconheceriam"',
    origin: "forbes.svg",
  },
  {
...
for (let tindex in testimonials) {
  ...
  img.setAttribute("src", "./assets/img/" + testimonials[tindex].origin);
  img.style.cursor = "pointer";
  img.addEventListener("click", () => fillTestimonial(tindex));
